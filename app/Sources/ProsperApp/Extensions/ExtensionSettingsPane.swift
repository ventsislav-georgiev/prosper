...
private struct SettingsRowView: View {
    ...
    var body: some View {
        ...
        // Deprecated and ignored since #119 (the recorder moved to Settings ›
        // Shortcuts for good) — a manifest still declaring it parses fine
        // (SettingsControlKind.shortcut) but renders nothing here.
        case "shortcut":   EmptyView()
